    ...
    return Component.extend({
        ...
        onShippingContactSelect: function(event, session) {
            ...
            storage.post(
                ...
                session.abort();
                console.error("Gene Apple Pay: Unable to find shipping methods for estimate-shipping-methods", r);
        ...
        startPlaceOrder: function(nonce, event, session) {
            ...
            storage.post(
                ...
                storage.post(
                    ...
                    console.error("Gene Apple Pay: Unable to take payment", r);
                    return false;
                });

            }.bind(this)).fail(function(r){ 
                console.error("Gene Apple Pay: Unable to set shipping information", r);
